...
class ESIM(nn.Module):
    """
    Implementation of the ESIM models presented in the paper "Enhanced LSTM for
    ...
    def __init__(self,
        ...
        """
        Args:
            vocab_size: The size of the vocabulary of embeddings in the models.
            ...
            padding_idx: The index of the padding token in the premises and
                hypotheses passed as input to the models. Defaults to 0.
            dropout: The dropout rate to use between the layers of the network.
                A dropout rate of 0 corresponds to using no dropout at all.
                Defaults to 0.5.
            num_classes: The number of classes in the output of the network.
                Defaults to 3.
            device: The name of the device on which the models is being
        ...
        # Initialize all weights and biases in the models.
    ...
    def forward(self,
        ...
        Returns:
            logits: A tensor of size (batch, num_classes) containing the
                logits for each output class of the models.
            probabilities: A tensor of size (batch, num_classes) containing
                the probabilities of each output class in the models.
        """
...
def _init_esim_weights(module):
    """
    Initialise the weights of the ESIM models.
    """
