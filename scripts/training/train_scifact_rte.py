"""
Train KBERT for SciFact RTE task
"""
import sys
import torch
import json
...
if __name__ == "__main__":
    ...
    # Path options.
    parser.add_argument("--pretrained_model_path", default="../../models/classifier_model.bin", type=str,
                        help="Path of the pretrained model.")
    parser.add_argument("--output_model_path", default="../../models/scifact/classifier_model.bin", type=str,
                        help="Path of the output model.")
    parser.add_argument("--vocab_path", default="../../models/google_vocab.txt", type=str,
                        help="Path of the vocabulary file.")

    parser.add_argument("--train_path", type=str, default="../../datasets/scifact/kbert_rte_train.tsv")
    parser.add_argument("--dev_path", type=str, default="../../datasets/scifact/kbert_rte_dev.tsv")
    parser.add_argument("--test_path", type=str, default="./datasets/scifact/kbert_rte_dev.tsv")
    ...
    # kg
    parser.add_argument("--kg_name", default="ConceptNet", help="KG name or path")
    ...
    if args.kg_name == "ConceptNetWithRank" or args.kg_name == "ConceptNet":
        args.kg_files = ["../../brain/scifact/conceptnet_1.tsv", "../../brain/scifact/conceptnet_2.tsv","../../brain/scifact/conceptnet_2.tsv"]
