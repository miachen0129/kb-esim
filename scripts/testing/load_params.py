...
def load_esim_params(device,
    ...
    ## Create and then load the model
    ...
    parser = argparse.ArgumentParser(description="Preprocess the scifact dataset")
    parser.add_argument(
        "--config",
        default=default_config,
        help="Path to a configuration file for preprocessing SciFact dataset"
    )
...
def load_kbert_params(  device,
    ...
    elif kgname=="none" or kgname==None:
        spo_files = []
