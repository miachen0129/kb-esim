"""
Code to represent a datasets release.
"""
...
class GoldDataset:
    """
    Class to represent a gold datasets, include corpus and claims.
    """
...
class Claim:
    """
    Class representing a single claim, with a pointer back to the datasets.
    """
    id: int
    claim: str
    ...
    def _format_evidence(evidence_dict):
        ...
        # each rationale can have its own support label. But, in the datasets,
