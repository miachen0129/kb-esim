...
def preprocess(inputdir,
    ...
    trainset = SciFactRationaleSelectionDataset(corpus_file, train_file)
    devset = SciFactRationaleSelectionDataset(corpus_file, dev_file)
...
if __name__ == "__main__":
    ...
    preprocess(
        ...
        "../../data/preprocessed/scifact_rationale",
